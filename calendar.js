...
!function() {
  ...
  Calendar.prototype.drawDay = function(day) {
    ...
    //Entries
    var entries = createElement('div', 'day-entries');
  ...
  Calendar.prototype.drawEntries = function(day, element) {
    if(day.month() === this.current.month() && this.entries) {
      ...
      todaysEntries.forEach(function(ev) {
  ...
  Calendar.prototype.renderEntries = function(entries, ele) {
    ...
    var currentWrapper = ele.querySelector('.entries');
    var wrapper = createElement('div', 'entries in' + (currentWrapper ? ' new' : ''));

    entries.forEach(function(ev) {
      var div = createElement('div', 'entry');
      var square = createElement('div', 'entry-category ' + ev.color);
    ...
    if(!entries.length) {
      var div = createElement('div', 'entry empty');
      var span = createElement('span', '', 'No Entries');
  ...
  Calendar.prototype.drawLegend = function() {
    ...
    const calendars = this.entries.map(function(e) {
